$(document).ready(function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        let tablita = $(".tablita2 tbody");
  
        roles.forEach((rol) => {
          let rolesWithoutEdit = [
            /* "administrador", */ "admision",
            "aranceles y cobranzas",
          ];
          let shouldHideEditButton = rolesWithoutEdit.includes(
            rol.descripcion_concepto.toLowerCase()
          );
